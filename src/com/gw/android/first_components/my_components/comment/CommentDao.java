...
public class CommentDao extends AbstractDao<Comment, Long> {
	...
	public static class Properties {
		...
		public final static Property Text = new Property(3, String.class,
				"text", false, "TEXT");
		public final static Property Date = new Property(4,
	...
	public Comment readEntity(Cursor cursor, int offset) {
		Comment entity = new Comment( //
				...
				cursor.isNull(offset + 4) ? null : new java.util.Date(
	...
	public void readEntity(Cursor cursor, Comment entity, int offset) {
		...
		entity.setDate(cursor.isNull(offset + 4) ? null : new java.util.Date(
