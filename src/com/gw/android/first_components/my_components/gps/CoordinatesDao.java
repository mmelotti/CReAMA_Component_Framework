...
public class CoordinatesDao extends AbstractDao<Coordinates, Long> {
	...
	public static class Properties {
		...
		public final static Property Latitude = new Property(3, double.class,
				"latitude", false, "LATITUDE");
		public final static Property Longitude = new Property(4, double.class,
				"longitude", false, "LONGITUDE");
		public final static Property AddressLine1 = new Property(5,
				String.class, "addressLine1", false, "ADDRESS_LINE1");
		public final static Property AddressLine2 = new Property(6,
				String.class, "addressLine2", false, "ADDRESS_LINE2");
		public final static Property AddressLine3 = new Property(7,
				String.class, "addressLine3", false, "ADDRESS_LINE3");
	};
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'COORDINATES' (" + //
				...
				"'ADDRESS_LINE1' TEXT," + // 5: addressLine1
				"'ADDRESS_LINE2' TEXT," + // 6: addressLine2
				"'ADDRESS_LINE3' TEXT);"); // 7: addressLine3
	}
	...
	public Coordinates readEntity(Cursor cursor, int offset) {
		Coordinates entity = new Coordinates(
				...
				cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // addressLine1
				cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // addressLine2
				cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7) // addressLine3
		);
		return entity;
	}
	...
	public void readEntity(Cursor cursor, Coordinates entity, int offset) {
		...
		entity.setAddressLine1(cursor.isNull(offset + 5) ? null : cursor
				.getString(offset + 5));
		entity.setAddressLine2(cursor.isNull(offset + 6) ? null : cursor
				.getString(offset + 6));
		entity.setAddressLine3(cursor.isNull(offset + 7) ? null : cursor
				.getString(offset + 7));
	}
