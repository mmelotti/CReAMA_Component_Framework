...
public class CoordinatesDao extends AbstractDao<Coordinates, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property AddressLine1 = new Property(5, String.class, "addressLine1", false, "ADDRESS_LINE1");
        public final static Property AddressLine2 = new Property(6, String.class, "addressLine2", false, "ADDRESS_LINE2");
        public final static Property AddressLine3 = new Property(7, String.class, "addressLine3", false, "ADDRESS_LINE3");
    };
    ...
    public void readEntity(Cursor cursor, Coordinates entity, int offset) {
        ...
        entity.setAddressLine1(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setAddressLine2(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setAddressLine3(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
     }
