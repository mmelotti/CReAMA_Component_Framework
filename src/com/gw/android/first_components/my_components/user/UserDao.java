...
public class UserDao extends AbstractDao<User, Long> {
	...
	public static class Properties {
		...
		public final static Property Usuario = new Property(3, String.class,
				"usuario", false, "USUARIO");
		public final static Property Sobrenome = new Property(4, String.class,
				"sobrenome", false, "SOBRENOME");
		public final static Property Escolaridade = new Property(5,
				String.class, "escolaridade", false, "ESCOLARIDADE");
		public final static Property Curso = new Property(6, String.class,
				"curso", false, "CURSO");
		public final static Property Instituicao = new Property(7,
				String.class, "instituicao", false, "INSTITUICAO");
		public final static Property Ocupacao = new Property(8, String.class,
				"ocupacao", false, "OCUPACAO");
		public final static Property Email = new Property(9, String.class,
				"email", false, "EMAIL");
	};
	...
	public void readEntity(Cursor cursor, User entity, int offset) {
		...
		entity.setServerId(cursor.isNull(offset + 2) ? null : cursor
				.getLong(offset + 2));
		entity.setUsuario(cursor.isNull(offset + 3) ? null : cursor
				.getString(offset + 3));
		entity.setSobrenome(cursor.isNull(offset + 4) ? null : cursor
				.getString(offset + 4));
		entity.setEscolaridade(cursor.isNull(offset + 5) ? null : cursor
				.getString(offset + 5));
		entity.setCurso(cursor.isNull(offset + 6) ? null : cursor
				.getString(offset + 6));
		entity.setInstituicao(cursor.isNull(offset + 7) ? null : cursor
				.getString(offset + 7));
		entity.setOcupacao(cursor.isNull(offset + 8) ? null : cursor
				.getString(offset + 8));
		entity.setEmail(cursor.isNull(offset + 9) ? null : cursor
				.getString(offset + 9));
	}
