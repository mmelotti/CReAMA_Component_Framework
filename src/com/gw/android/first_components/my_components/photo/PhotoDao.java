...
public class PhotoDao extends AbstractDao<Photo, Long> {
	...
	public static class Properties {
		...
		public final static Property IsThumb = new Property(3, Boolean.class,
				"isThumb", false, "IS_THUMB");
		public final static Property PhotoBytes = new Property(4, byte[].class,
				"photoBytes", false, "PHOTO_BYTES");
		public final static Property Text = new Property(5, String.class,
				"text", false, "TEXT");
	...
	public Photo readEntity(Cursor cursor, int offset) {
		Photo entity = new Photo( //
				...
				cursor.isNull(offset + 3) ? null
						: cursor.getShort(offset + 3) != 0, // isThumb
	...
	public void readEntity(Cursor cursor, Photo entity, int offset) {
		...
		entity.setServerId(cursor.isNull(offset + 2) ? null : cursor
				.getLong(offset + 2));
		entity.setIsThumb(cursor.isNull(offset + 3) ? null : cursor
				.getShort(offset + 3) != 0);
		entity.setPhotoBytes(cursor.isNull(offset + 4) ? null : cursor
				.getBlob(offset + 4));
		entity.setText(cursor.isNull(offset + 5) ? null : cursor
				.getString(offset + 5));
